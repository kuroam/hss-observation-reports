...
このリポジトリは、初期段階では private として運用します。

公開、英語化、PDF化は、別途判断します。

## Reports

| No. | Title                | File                                                                                 |
| --- | -------------------- | ------------------------------------------------------------------------------------ |
| 001 | ドラッカーのマネジメントとKPIへの圧縮 | [reports/ja/001_drucker_management_kpi.md](reports/ja/001_drucker_management_kpi.md) |
