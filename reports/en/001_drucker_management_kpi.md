...
```mermaid
flowchart LR
  A[Drucker-like questions<br/>mission / customer / customer value / results / plan]
    --> B[Practical management forms<br/>objectives / MBO / KPI / evaluation / dashboard]

  B --> C[Institutionalization / operation]
  C --> D[Circulation as compressed symbols]
  D --> E{Can reconnection happen?}

  E --Reconnection remains--> F[Purpose / customer / value / results remain visible]
  F --> A

  E --Reconnection narrows--> G[Indicators behave like objectives]
  G -.fixation.-> H[KPIs move from guideposts toward objectives themselves]
```
