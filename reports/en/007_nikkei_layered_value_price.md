...
```mermaid
flowchart LR
A[workers / workplaces / operations]
--> B[endurance / coordination / quality maintenance / tacit knowledge]

B --> C[value layered inside companies]
C --> D[profits / cash / stable supply / low-cost structure]

D --> E[market-processable forms<br/>PBR / ROE / capital efficiency / shareholder returns]
E --> F[stock prices / Nikkei 225 / index rise]

F --> G{does it reconnect to<br/>the place where value layered?}

G -- reconnects --> H[wages / investment / staffing / skill succession / workplace improvement]
G -- reconnection routes narrow --> I[numbers rise, but<br/>the layering source becomes hard to see]
```
