...
```mermaid
flowchart LR
  A[External connection structures<br/>society / market / organization / evaluation / visibility / performance demands]
    --> B[Processing forms<br/>management / optimization / responsibility]

  B --> C[Appear to be<br/>routed toward the individual side]

  C --> D[Observed states<br/>self-management / self-optimization / self-responsibilization]

  D -.difficult to return through the individual alone.-> A

  subgraph R001[Connection to Report 001]
    E[Questions / purpose / customer value]
      --> F[KPI / evaluation system / dashboard]
  end

  F -.corresponds to organizational-side compression.-> B
```
