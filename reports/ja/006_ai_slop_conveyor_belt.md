...
ベルトコンベア型消費とは、特定のアプリ利用そのものではなく、平台・検索・推薦・ランキング・自動再生・プレイリストなどによって候補列が先に供給され、利用者がその候補列の中で、見る、聴く、飛ばす、保存する、反応する、フォローする、といった選別を行う消費形式である。
...
| ベルトコンベア型市場 | 大量流入を後段処理する候補供給構造 | 再生数ビジネス、反応指標 |
