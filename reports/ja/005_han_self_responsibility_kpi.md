...
自己責任化が固定化symbolとして流通すると、管理・最適化・責任が個人側に置かれたように見えやすくなる。

ただし、その処理が完全に閉じるとは限らない。

HSSでは、次のような痕跡を Blue residuals / 再接続可能領域として観測できる。

- 自分だけの問題として処理しきれない違和感
- 成果要求や可視化への疲労感として残る痕跡
- 個人努力では戻しにくい外部構造への問い
- 管理・最適化・責任がどこから来ているのかを再確認する問い
- 組織、制度、市場、評価形式へ再接続しようとする会話や記録

ここで扱うのは、個人の内面や精神状態そのものではない。

HSSで扱うのは、それらがL1〜L6上に現れた反応、痕跡、symbol、処理形式、ルーティング、固定化、再接続可能性である。
...
- 接続確認:
  自己責任化は、個人の責任が実際に増えた状態としてではなく、管理・最適化・責任が個人側へルーティングされたように見える接続状態として観測できる。
- 処理形式への吸収:
  成果要求、可視化、管理、最適化、責任は、個人側の自己管理・自己最適化・自己責任として処理されやすい。
- 固定化傾向あり:
  「自己責任」というsymbolが固定化すると、外部接続構造へ戻る経路が見えにくくなる。
- Blue residualsあり:
  違和感、疲労感、過負荷感、説明しきれなさが残る場合、それらは再接続可能な痕跡として観測できる。
- 再接続可能領域あり:
  個人側に置かれた管理・最適化・責任を、組織、制度、市場、評価形式へ戻して読む経路が残る。
- 対象外レイヤー:
  個人心理、精神診断、幸福論、倫理判断、Hanの原典意図の確定は扱わない。
...
- 自己責任化は、自己から出発するものではなく、管理・最適化・責任が個人側へルーティングされた状態として観測できる。
- これにより、個人心理と、外部からルーティングされた処理形式を分けて見ることができる。
- HSS上の差分は、管理・最適化・責任がどこから来たように見え、どこに置かれ、どこで再接続経路が細るかというルーティング観測にある。

## 見えなかったこと / 保留

- このレポートでは、個人心理、疲労そのもの、幸福、医学的診断、Hanの確定的意図は直接観測していない。
- 現時点のレポートでは、Blue residuals や再接続よりも、固定化とルーティングを強く観測している。
- 再接続経路がどこに残るかは、保留の観測点として残る。
