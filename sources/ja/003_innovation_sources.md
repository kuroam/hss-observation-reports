...
また、経営学、組織論、イノベーション研究の厳密な文献レビューでもありません。

ここでは、平均化された「イノベーション、business case、business process、phase-gate、formal organization」像を形成するために使った source anchor を記録します。

## イノベーションに関するsource anchor
...
これらのソースは、特定の企業、組織、承認プロセス、予算管理、business case、KPI、phase-gate を評価するためのものではありません。

ここでは、HSSを仮の観測軸として用いる前に、流通しているイノベーションと組織内処理形式の文脈を確認するために使用します。
