...
ここでは、日経平均、指数構造、企業統治改革、資本効率、実質賃金、企業内に積層された価値と価格化される数字のズレを観測するために使う source anchor を記録します。

これらのソースは、HSSの根拠や証明ではありません。

これらのソースは、投資助言、株価予測、個別銘柄評価、企業批判、労働者評価を行うためのものではありません。
...
これらのソースは、日経平均の上昇理由を確定するためのものではありません。

これらのソースは、株価予測、投資助言、個別銘柄評価、企業批判、労働者評価を行うためのものではありません。

ここでは、HSSを仮の観測軸として用いる前に、日経平均、指数構造、企業統治改革、資本効率、実質賃金、労働側に積層された価値と価格化される数字のズレを確認するために使用します。
